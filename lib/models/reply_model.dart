...
class Reply {
  ...
  @override
  String toString() {
    return 'Reply(text: $text, hashtags: $hashtags, link: $link, imageLinks: $imageLinks, uid: $uid, tweetType: $tweetType, createdAt: $createdAt, likes: $likes, commentIds: $commentIds, id: $id, reShareCount: $reShareCount,reMemoryBy:$reMemoryBy,repliedTo:$repliedTo)';
  }
